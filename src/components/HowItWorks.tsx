  ...
  return (
    <section className="py-12 sm:py-16 bg-white">
      <div className="container mx-auto px-4 text-center">
        ...
        <p
          className="text-gray-600 mb-8 sm:mb-12 max-w-2xl mx-auto"
          data-aos="fade-up"
          data-aos-delay="100"
        >
          {language === "English"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-3 gap-8 relative">
          {steps.map((step, index) => (
            ...
            >
              <div
                className="w-16 h-16 sm:w-20 sm:h-20 bg-orange-500 rounded-full mx-auto mb-4 flex items-center justify-center"
                data-aos="zoom-in"
              ...
              <h3 className="text-lg sm:text-xl font-semibold mb-2">
                {language === "English" ? step.title.en : step.title.ru}
              </h3>
